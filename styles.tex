...
\newcommand{\seq}[1]{#1_1, #1_2, \dotsc,#1_n}
\newcommand{\vseq}[1]{(#1_i)_{i\in\mathbb{N}}}
...
\newcommand{\centernot}[1]{\mathrel{\mathpalette\@nll{#1}}}
\makeatother

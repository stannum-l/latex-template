...
\newenvironment{enumL}{\begin{enumerate}[label=(\alph*), ref=\alpha*]}{\end{enumerate}}
\newenvironment{enumA}{\begin{enumerate}[label=(\arabic*), ref=\arabic*]}{\end{enumerate}}
...
\newcommand{\brk}[2][0]{\delimit{#1}{\langle}{#2}{\rangle}}
...
\declaretheoremstyle[
  ...
  headfont=\color{YellowOrange}\sffamily\bfseries,
  spaceabove=8pt,
  spacebelow=8pt,
  bodyfont=\normalfont
]{answerhead}
...
\declaretheoremstyle[
  headfont=\bfseries\sffamily\color{Salmon!70!black},
  bodyfont=\normalfont,
  spaceabove=2pt,
  spacebelow=1pt,
...
\declaretheorem[style=answerhead,name=Answer,sibling=theorem]{answer}
\declaretheorem[style=answerhead,name=Answer,numbered=no]{answer*}
\declaretheorem[style=answerhead,name=Fact,sibling=theorem]{fact}
...
% \newenvironment{scsoln}{\begin{proof}[\normalfont \scshape Solution]}{\end{proof}}
